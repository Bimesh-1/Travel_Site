...
class App_KernelDevDebugContainer extends Container
{
    ...
    private $loadedDynamicParameters = [
        ...
        'app.weather_api_key' => false,
        'app.mapbox_api_key' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'app.weather_api_key' => $container->getEnv('WEATHER_API_KEY'),
            'app.mapbox_api_key' => $container->getEnv('MAPBOX_API_KEY'),
